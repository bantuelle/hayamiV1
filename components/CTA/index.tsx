          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Discover Skilled Professionals & Services Today
              </h2>
              <p>
                Hayami connects you with trusted local professionals and services to make your life easier. Find what you need, when you need it, all in one app.
              </p>
            </motion.div>
            <motion.div
              variants={{
