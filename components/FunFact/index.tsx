        ...
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          >
            <h2 className="mb-4 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle3">
              Empowering Your Daily Connections
            </h2>
            <p className="mx-auto lg:w-11/12">
              Hayami bridges the gap between users and reliable services. With
              Hayami, finding the right help has never been easier, faster, or
              more convenient.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Requests Completed</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Average Rating</p>
            </motion.div>
          </div>
        </div>
      </section>
